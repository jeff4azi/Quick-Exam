...
const StartExam = ({
  ...
  return (
    <div className="relative h-[100dvh] max-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Slide-in menu */}
      <div
        className={`fixed top-0 right-0 h-full w-1/2 max-w-[400px] bg-white z-50 shadow-xl
      ...
      >
        <div className="p-6">
          ...
          <ul className="space-y-4 lg:text-lg">
            <li className="hover:text-blue-600 cursor-pointer gap-2 flex items-center">
              <div>
            ...
            <li className="hover:text-blue-600 cursor-pointer gap-2 flex items-center" onClick={() => navigate("/bookmarks")}>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="lg:size-6" viewBox="0 0 16 16">
