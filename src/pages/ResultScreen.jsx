    ...
    <div className='h-[100dvh] max-h-screen p-7 flex flex-col justify-between lg:max-w-2xl mx-auto'>
      ...
      <div className='flex justify-between px-7 py-5 text-gray-600'>
        <div className='text-xs flex flex-col items-center justify-center gap-2'>
          <div>
            <button className='p-2 bg-amber-400 rounded-full text-white shadow-sm hover:scale-105 active:scale-95 duration-200' onClick={() => {
              navigate("/exam")
              setAnswers([])
              ReactGA.event({
                category: "Exam",
        ...
        <div className='text-xs flex flex-col items-center justify-center gap-2'>
          <div>
            <button className='p-2 bg-red-400 rounded-full text-white shadow-sm active:scale-95 hover:scale-105 durations-200' onClick={() => {
