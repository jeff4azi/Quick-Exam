    ...
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950 text-slate-900 dark:text-gray-100 selection:bg-blue-100 dark:selection:bg-blue-900/30 transition-colors duration-300">
      ...
      <section className="py-24 px-6 bg-slate-50 dark:bg-gray-950">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {(reviews.length > 0 ? reviews : fallbackTestimonials).map(
              (t, i) => (
                <div
                  key={i}
                  className="group bg-white dark:bg-gray-900 p-8 rounded-3xl border border-slate-200 dark:border-gray-800 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between"
                >
                  <div>
                    <svg
                      className="size-8 text-blue-600/20 dark:text-blue-500/30 mb-4"
                      fill="currentColor"
                      viewBox="0 0 32 32"
                    >
                    ...
                    <p className="text-sm text-slate-600 dark:text-gray-300 leading-relaxed mb-8">
                      {t.comment}
                    </p>
                  </div>

                  <div className="flex items-center gap-3 pt-6 border-t border-slate-100 dark:border-gray-800">
                    <Avatar avatarUrl={t.avatarUrl} size="sm" />
